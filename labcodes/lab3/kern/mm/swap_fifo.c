...
_fifo_swap_out_victim(struct mm_struct *mm, struct Page ** ptr_page, int in_tick)
{
     ...
     /* Select the victim */
     /*LAB3 EXERCISE 2: YOUR CODE*/ 
     list_entry_t *l = list_next(head);//(1)  unlink the  earliest arrival page in front of pra_list_head qeueue
     *ptr_page = le2page(l, pra_page_link);//(2)  set the addr of addr of this page to ptr_page
     list_del(l);
     return 0;
}
